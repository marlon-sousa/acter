...
//! entity/value config, the fake session service, the Channel event-sink and system
//! clock adapters, and the container that wires everything. Folders are organized by module role (see
//! ARCHITECTURE.md).
//!
