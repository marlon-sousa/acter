...
- 54. **Open** — V3, the output carries the far end's colours. Spec: [v3-the-output-carries-the-far-ends-colours.md](specs/v3-the-output-carries-the-far-ends-colours.md).
